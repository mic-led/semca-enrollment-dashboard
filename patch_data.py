...
START_ANOMALY     = "// SEMCA_ANOMALY_DATA_START"
END_ANOMALY       = "// SEMCA_ANOMALY_DATA_END"
START_RAWDATA     = "// SEMCA_RAWDATA_START"
END_RAWDATA       = "// SEMCA_RAWDATA_END"
START_CALENDAR    = "// SEMCA_CALENDAR_START"
END_CALENDAR      = "// SEMCA_CALENDAR_END"
...
anomaly_data     = extract_region(generated, START_ANOMALY,     END_ANOMALY)
rawdata_data     = extract_region(generated, START_RAWDATA,     END_RAWDATA)
calendar_data    = extract_region(generated, START_CALENDAR,    END_CALENDAR)
...
live = replace_region(live, START_ANOMALY,     END_ANOMALY,     anomaly_data)
live = replace_region(live, START_RAWDATA,     END_RAWDATA,     rawdata_data)
live = replace_region(live, START_CALENDAR,    END_CALENDAR,    calendar_data)
